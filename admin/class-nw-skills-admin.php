...
class NW_Skills_Admin {
    ...
    public function register_menu(): void {
        add_submenu_page(
            'neoweaver', 'Skills', 'Skills', 'manage_options',
    ...
    public function enqueue( string $hook ): void {
        ...
        wp_enqueue_script( 'nw-skills', NW_PLUGIN_URL . 'admin/js/nw-skills.js', [ 'jquery' ], NW_VERSION, true );
        wp_localize_script( 'nw-skills', 'NW_SK', [
