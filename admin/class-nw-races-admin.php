...
if ( ! class_exists( 'NeoWeaver_Races_Admin' ) ) {
	...
	class NeoWeaver_Races_Admin {
		...
		public function enqueue( string $hook ): void {
			...
			wp_enqueue_script(
				'nw-races',
				NW_PLUGIN_URL . 'admin/js/nw-races.js',
				[ 'jquery' ],
				NW_VERSION,
				true
			);
...
/**
 * Instantiate the legacy races admin so its menu and AJAX hooks register.
 * Use plugins_loaded to ensure dependent plugin code is available first.
 */
add_action(
	'plugins_loaded',
	static function () {
