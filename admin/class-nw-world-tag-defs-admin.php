    ...
    public function render_page(): void { ?>
        <div class="wrap nw-panel" id="nw-wtd-panel">
            ...
            <div class="nw-filter-bar">
                ...
                <input type="text" id="nw-filter-search" class="nw-filter-input" placeholder="Search code, label or description&hellip;">
            </div>
            ...
            <div class="nw-table-wrap">
                <table class="nw-table">
                    ...
                    <tbody id="nw-wtd-tbody">
                        <tr class="nw-loading-row"><td colspan="9"><div class="nw-spinner"></div> Loading tag defs&hellip;</td></tr>
                    </tbody>
                </table>
            </div>
                        ...
                        <form id="nw-wtd-form">
                            ...
                            <div class="nw-form-grid">
                                ...
                                <div class="nw-field nw-field-full">
                                    ...
                                    <textarea id="nw-field-description" name="description" rows="3" placeholder="What this tag means in the world&hellip;"></textarea>
                                </div>
                            </div>
