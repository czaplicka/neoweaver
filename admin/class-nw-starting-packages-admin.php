...
class NeoWeaver_Starting_Packages_Admin {
    ...
    public function enqueue_assets( string $hook ): void {
        ...
        wp_enqueue_style( 'nw-starting-packages-admin', $base . 'css/starting-packages-admin.css', [ 'chakra-petch' ], $ver );
        wp_enqueue_script( 'nw-starting-packages-admin', $base . 'js/starting-packages-admin.js', [ 'jquery' ], $ver, true );
    }
