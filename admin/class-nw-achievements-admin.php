...
class NeoWeaver_Achievements_Admin {
    ...
    public function enqueue_assets( string $hook ): void {
        ...
        // Register a named handle so wp_localize_script works correctly
        wp_register_script( 'nw-achievements-admin', false, [ 'jquery' ], null, true );
        wp_enqueue_script( 'nw-achievements-admin' );

        // Inject ajaxurl + nonce via wp_localize_script (safe, always defined)
