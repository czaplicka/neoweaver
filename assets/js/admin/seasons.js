...
(function ($) {
	...
	const WEATHERS = [
		{ key: 'sun',    label: 'Sun',    icon: '<span data-lucide="sun"></span>', color: '#facc15' },
		{ key: 'cloudy', label: 'Cloudy', icon: '<span data-lucide="cloud"></span>', color: '#94a3b8' },
		{ key: 'rain',   label: 'Rain',   icon: '<span data-lucide="cloud-rain"></span>', color: '#60a5fa' },
		{ key: 'fog',    label: 'Fog',    icon: '<span data-lucide="cloud-fog"></span>', color: '#a1a1aa' },
		{ key: 'storm',  label: 'Storm',  icon: '<span data-lucide="cloud-lightning"></span>', color: '#f87171' },
		{ key: 'snow',   label: 'Snow',   icon: '<span data-lucide="snowflake"></span>', color: '#bae6fd' },
	];
