		...
		<div id="tw-char-creator-wrapper" class="tw-character-creator tw-char-creator">
			<div class="tw-progress-bar">
				<div class="tw-progress-header">
					<div class="tw-progress-label">
						...
						<span class="tw-blink" aria-hidden="true"></span>
					</div>
			...
			<section class="tw-char-step active" data-phase="IDENTITY SYNC">
				<div class="tw-step-error">
					<span class="tw-step-error__icon" aria-hidden="true">⚠</span>
					<span class="tw-step-error__msg"></span>
				</div>

				<h2>Identity Sync</h2>
				<p class="tw-question-text">
					Define your operative signal, visible identity, and pronoun channel before entering the Grid.
				</p>
				...
				<fieldset class="tw-pronoun-fieldset">
					...
					<div class="tw-pronoun-options">
						<label class="tw-pronoun-option">
							<input type="radio" class="tw-pronoun-radio" name="tw_char_pronouns" value="she">
							<span class="tw-pronoun-label">she / her</span>
						</label>

						<label class="tw-pronoun-option">
							<input type="radio" class="tw-pronoun-radio" name="tw_char_pronouns" value="he">
							<span class="tw-pronoun-label">he / him</span>
						</label>

						<label class="tw-pronoun-option">
							<input type="radio" class="tw-pronoun-radio" name="tw_char_pronouns" value="they">
							<span class="tw-pronoun-label">they / them</span>
						</label>

						<label class="tw-pronoun-option">
							<input type="radio" class="tw-pronoun-radio" name="tw_char_pronouns" value="xe">
							<span class="tw-pronoun-label">xe / xem</span>
						</label>

						<label class="tw-pronoun-option">
							<input type="radio" class="tw-pronoun-radio" name="tw_char_pronouns" value="custom">
				...
				<div class="tw-nav-row">
					<div></div>
					<button type="button" id="tw-char-step1-next" class="tw-btn tw-btn--primary tw-btn-next">
						Continue
					</button>
				</div>
			</section>
			...
			<section class="tw-char-step" data-phase="RACE PROTOCOL">
				...
				<h2>Race Protocol</h2>
				<p class="tw-question-text">
					Choose your parent race first. Then, if available, pick a subrace. Only the subrace is stored in the character record.
				</p>
			...
			<section class="tw-char-step" data-phase="CLASS MATRIX">
				...
				<h2>Class Matrix</h2>
				<p class="tw-question-text">
					Select your operative class. The chosen class sets your skill limit and filters compatible starting packages by class tag.
				</p>
			...
			<section class="tw-char-step" data-phase="BIOMETRIC CALIBRATION">
				...
				<div class="tw-attr-presets">
					<span class="tw-attr-presets__label">Presets</span>

					<button type="button" class="tw-attr-preset-btn" data-preset="balanced" aria-pressed="false">
						Balanced
					</button>

					<button type="button" class="tw-attr-preset-btn" data-preset="agile" aria-pressed="false">
						Agile
					</button>

					<button type="button" class="tw-attr-preset-btn" data-preset="tank" aria-pressed="false">
						Tank
					</button>

					<button type="button" class="tw-attr-preset-btn" data-preset="bodybuilder" aria-pressed="false">
						Body Builder
					</button>
				</div>
			...
			<section class="tw-char-step" data-phase="SKILL SELECTION">
				...
				<p class="tw-question-text">
					Choose your active skills. The maximum number depends on the class selected in the previous step.
				</p>
			...
			<section class="tw-char-step" data-phase="STARTING PACKAGE">
				...
				<p class="tw-question-text">
					Choose one player-selectable package compatible with your class tag.
				</p>
			...
			<section class="tw-char-step" data-phase="DATA ORIGIN">
				...
				<h2>Data Origin</h2>
				<p class="tw-question-text">
					Select the environment where your consciousness first stabilized.
				</p>
			...
			<section class="tw-char-step" data-phase="PREVIOUS OPERATION">
				...
				<p class="tw-question-text">
					Choose the main operational pattern your unit was shaped by before this deployment.
				</p>
			...
			<section class="tw-char-step" data-phase="SYNCHRONIZATION CRISIS">
				...
				<p class="tw-question-text">
					Select your crisis response profile. The three lore choices together define the backstory tags saved for the character.
				</p>
			...
			<section class="tw-char-step" data-phase="VISUAL SIGNATURE">
				...
				<p class="tw-question-text">
					Add a portrait and optional short bio for your operative.
				</p>
				...
				<label class="tw-field-label" for="tw-char-bio">
					...
					<textarea
						id="tw-char-bio"
						name="bio"
						placeholder="Write a short bio, personality trace, or external-facing profile."
						maxlength="1000"
					></textarea>
				</label>
			...
			<section class="tw-char-step" data-phase="SYSTEM REVIEW">
				...
				<h2>System Review</h2>
				<p class="tw-question-text">
					Review the full configuration before deployment.
				</p>
				...
				<div class="tw-nav-row">
					<button type="button" class="tw-btn-nav tw-btn-prev tw-btn-review-return" data-dir="prev">
						Back
					</button>

					<button type="button" id="tw-char-submit" class="tw-btn tw-btn--primary">
						DEPLOY OPERATIVE
					</button>
				</div>
			</section>
