...
if ( ! function_exists( 'neoweaver_register_character_creator_assets' ) ) {
	function neoweaver_register_character_creator_assets(): void {
		...
		wp_register_style(
			...
			$css_url,
			[],
			(string) filemtime( NEOWEAVER_PLUGIN_DIR . 'assets/css/public/character-creator.css' )
		);
		...
		wp_register_script(
			...
			$js_url,
			[],
			(string) filemtime( NEOWEAVER_PLUGIN_DIR . 'assets/js/public/character-creator.js' ),
			true
		);
