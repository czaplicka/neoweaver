...
if ( ! function_exists( 'tw_connect_character_campaign_render' ) ) {
	function tw_connect_character_campaign_render(): string {
		...
		ob_start();
		?>
		<div id="tw-deployment-root" class="tw-deployment-main-container" data-tw-connect-character-campaign="1">
			...
			<section class="tw-briefing-hero">
				...
				<div class="tw-hero-content">
					<div class="tw-hero-text">
						...
						<p>
							Operator, select a verified Agent entity to inhabit the targeted Deployment matrix.
							Note: Agents are locked to the World Node of their first deployment.
						</p>
					</div>
							...
							<div class="tw-field-box">
								...
								<div class="tw-input-wrapper">
									...
									<select
										...
										size="6"
										required
										aria-label="Select deployment"></select>
								</div>
							</div>
							...
							<div class="tw-field-box">
								...
								<div class="tw-input-wrapper">
									...
									<select
										...
										size="6"
										required
										aria-label="Select agent"></select>
								</div>
							</div>
...
add_shortcode( 'tw_connect_character_campaign', 'tw_connect_character_campaign_render' );
